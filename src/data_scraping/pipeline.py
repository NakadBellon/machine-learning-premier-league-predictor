...
try:
    ...
    print(" MLflow non disponible - le tracking sera désactivé")
...
try:
    ...
    print(" Cleaner non disponible - phase de nettoyage ignorée")
...
try:
    ...
    print(" FeatureEngineer non disponible - phase features ignorée")
...
def run_pipeline():
    ...
    try:
        ...
        if CLEANER_AVAILABLE:
            ...
            logger.info(" Phase nettoyage ignorée (cleaner non disponible)")
        ...
        if FEATURES_AVAILABLE and CLEANER_AVAILABLE:
            ...
            logger.info(" Phase feature engineering ignorée")
